function Link() {
  return (
    <div className="box-border content-stretch flex items-center justify-center px-[8px] py-[12px] relative shrink-0" data-name="Link">
      <p className="font-['Fraunces',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#4e4e4e] dark:text-neutral-400 text-[12px] text-nowrap tracking-[0.5px] whitespace-pre">Theming</p>
    </div>
  );
}
...
function Link1() {
  return (
    <div className="box-border content-stretch flex items-center justify-center px-[8px] py-[12px] relative shrink-0" data-name="Link">
      <p className="font-['Fraunces',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[#4f3583] dark:text-[#b9a5e6] text-[12px] text-nowrap whitespace-pre">Theme Designer</p>
    </div>
  );
}
...
export default function Breadcrumb() {
  return (
    <div className="bg-[#f9f9f9] dark:bg-[#0f0f12] relative w-full h-[53px]" data-name="Breadcrumb Navigation">
